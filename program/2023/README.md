...
- Descrição: O [Omunga](https://github.com/OMUNGA) Plataforma Angolana de Artigos de TI, a versão atual do projeto esta com uma arquitetura não muito aconselhavel, e código não muito legivel.
